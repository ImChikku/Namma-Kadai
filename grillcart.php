...
<?php
  ...
  ?>
	    ...
	    <li><a href="#"> Welcome <?php echo $_SESSION['login_user2']; ?> </a></li>
            ...
            <li class="active" ><a href="grillfoodlist.php"><i class="fas fa-utensils"> Food Zone  </i></a></li>
            <li><a href="grillcart.php"><i class="fas fa-shopping-cart"> Cart(<?php
...
<td><a href="grillcart.php?action=delete&id=<?php echo $values["food_id"]; ?>">Remove</a></td>
</tr>
...
<?php
  echo '<a href="grillcart.php?action=empty">
<button class="btn btn-danger"> Empty Cart</button></a>&nbsp;<a href="grillfoodlist.php">
<button class="btn btn-warning">Continue Shopping</button></a>&nbsp;<a href="grillpayment.php">
...
if(empty($_SESSION["cart"]))
{
 ...
 <div class="container" style="background:linear-gradient(-180deg,black, silver);padding:20px;margin-top:2%;color:black">
      <div class="jumbotron">
        <h1>Your Shopping Cart</h1>
        <p>Oops! We can't smell any food here. Go back and <a href="grillfoodlist.php">order now.</a></p>
...
echo '<script>window.location="grillcart.php"</script>';
}
else
{
