...
<?php
  ...
  ?>
	    ...
	    <li><a href="#"> Welcome <?php echo $_SESSION['login_user2']; ?> </a></li>
            ...
            <li class="active" ><a href="burgurfoodlist.php"><i class="fas fa-utensils"> Food Zone  </i></a></li>
            <li><a href="burgurcart.php"><i class="fas fa-shopping-cart"> Cart(<?php
...
<td><a href="burgurcart.php?action=delete&id=<?php echo $values["food_id"]; ?>">Remove</a></td>
</tr>
...
<?php
  echo '<a href="burgurcart.php?action=empty">
<button class="btn btn-danger"> Empty Cart</button></a>&nbsp;<a href="burgurfoodlist.php">
<button class="btn btn-warning">Continue Shopping</button></a>&nbsp;<a href="burgurpayment.php">
<button class="btn btn-success pull-right">Check Out</button></a>';
?>
</div>
...
if(empty($_SESSION["cart"]))
{
  ...
  <div class="container" style="background:linear-gradient(-180deg,black, silver);padding:20px;margin-top:2%;color:black">
      <div class="jumbotron">
        <h1>Your Shopping Cart</h1>
        <p>Oops! We can't smell any food here. Go back and <a href="burgurfoodlist.php">order now.</a></p>
...
echo '<script>window.location="burgurcart.php"</script>';
}
else
{
