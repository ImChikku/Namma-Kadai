...
header("location: customerlogin_z.php"); 
}
?>
...
background: linear-gradient(-90deg,black,skyblue);
}
...
$sql = "SELECT * FROM FOOD WHERE shop_name='zwarma'";
...
<form method="post"  action="zwarmacart.php?action=add&id=<?php echo $row["F_ID"]; ?>">
