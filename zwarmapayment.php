...
<?php
  ...
  ?>
           ...
           <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="zwarmafoodlist.php"><i class="fas fa-utensils"> Food Zone </i></a></li>
            <li><a href="zwarmacart.php"><i class="fas fa-shopping-cart"> Cart
             (<?php
...
<h1 class="text-center">
  <a href="zwarmacart.php"><button class="btn btn-warning" > Go back to cart</button></a>
<a href="zwarmaCOD.php"><button class="btn btn-warning" name="submit" >SUBMIT</button></a>
