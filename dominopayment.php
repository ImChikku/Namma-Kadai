...
<?php
  ...
  ?>
           ...
           <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="dominofoodlist.php"><i class="fas fa-utensils"> Food Zone </i></a></li>
            <li><a href="dominocart.php"><i class="fas fa-shopping-cart"> Cart
             (<?php
...
<h1 class="text-center">
  <a href="dominocart.php"><button class="btn btn-warning"> Go back to cart</button></a>
<a href="dominoCOD.php"><button class="btn btn-warning" name="submit" >SUBMIT</button></a>
