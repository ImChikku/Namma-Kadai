...
background: linear-gradient(90deg,black, cornsilk);
}
...
$sql = "SELECT * FROM FOOD WHERE shop_name='mcdonald'";
...
<form method="post"  action="mcdonaldcart.php?action=add&id=<?php echo $row["F_ID"]; ?>">
