...
header("location: customerlogin_g.php"); 
}
?>
...
background: linear-gradient(-90deg,black,aquamarine);
}
...
$sql = "SELECT * FROM FOOD WHERE shop_name='grill'";
...
<form method="post"  action="grillcart.php?action=add&id=<?php echo $row["F_ID"]; ?>">
