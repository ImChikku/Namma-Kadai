...
header("location: customerlogin_m.php"); 
}
?>
...
<?php
  ...
  ?>
           ...
           <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="mcdonaldfoodlist.php"><i class="fas fa-utensils"> Food Zone </i></a></li>
            <li><a href="mcdonaldcart.php"><i class="fas fa-shopping-cart"> Cart
             (<?php
...
<h1 class="text-center">
  <a href="mcdonaldcart.php"><button class="btn btn-warning"> Go back to cart</button></a>
<a href="mcdonaldCOD.php"><button class="btn btn-warning" name="submit" >SUBMIT</button></a>
