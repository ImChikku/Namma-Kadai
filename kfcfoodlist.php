...
header("location: customerlogin_k.php"); 
}
...
body {
 ...
 background-image: url('bgimg1.jpg'); 
  ...
  background: linear-gradient(-90deg,black, #ffc837);
}
...
<form method="post"  action="kfccart.php?action=add&id=<?php echo $row["F_ID"]; ?>">
