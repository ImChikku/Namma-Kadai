...
<?php
  ...
  ?>
           ...
           <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="kfcfoodlist.php"><i class="fas fa-utensils"> Food Zone </i></a></li>
            <li><a href="kfccart.php"><i class="fas fa-shopping-cart"> Cart
             (<?php
...
<h1 class="text-center">
  <a href="kfccart.php"><button class="btn btn-warning"> Go back to cart</button></a>
<a href="kfcCOD.php"><button class="btn btn-warning" name="submit" >SUBMIT</button></a>
