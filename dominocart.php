...
<td><a href="dominocart.php?action=delete&id=<?php echo $values["food_id"]; ?>">Remove</a></td>
</tr>
...
<?php
  echo '<a href="dominocart.php?action=empty">
<button class="btn btn-danger"> Empty Cart</button></a>&nbsp;<a href="dominofoodlist.php">
<button class="btn btn-warning">Continue Shopping</button></a>&nbsp;<a href="dominopayment.php">
...
if(empty($_SESSION["cart"]))
{
 ...
 <div class="container" style="background:linear-gradient(-180deg,black, silver);padding:20px;margin-top:2%;color:black">
      <div class="jumbotron">
        <h1>Your Shopping Cart</h1>
        <p>Oops! We can't smell any food here. Go back and <a href="dominofoodlist.php">order now.</a></p>
...
echo '<script>window.location="dominocart.php"</script>';
}
else
{
